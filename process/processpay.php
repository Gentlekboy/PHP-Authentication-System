<?php
  ...
  $txref = "rave-2993baufaeOGfeuhjkhvg651568;"; // ensure you generate unique references per transaction.
  $PBFPubKey = "FLWPUBK_TEST-9f69c64466b1aa52e4d240fd05cf61d6-X"; // get your public key from the dashboard.
  $redirect_url = "http://localhost/SNGH/process/processtransact.php";
