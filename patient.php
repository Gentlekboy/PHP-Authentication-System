...
?>
  ...
  <body>
    ...
    <nav class="my-2 my-md-0 mr-md-3">
      <a class="p-2 text-dark" href="wards.php">Appointments</a>
      <a class="p-2 text-dark" href="cmd.php">Message a Medical Personnel</a>
    ...
    <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
      ...
      <p>
        ...
        <a type="button" class="btn btn-bg btn-outline btn-primary" href="forgot.php">Forgot Password</a>
      </p>
    </div>
